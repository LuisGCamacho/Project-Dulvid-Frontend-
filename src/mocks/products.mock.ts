...
export const products: Product[] = [
    ...
    },
    {
        ...
        category: "Sudaderas",
        description:
            "Sudadera con capucha de alta calidad con logo Tesla bordado.",
        sizes: ["S", "M", "L", "XL", "XXL"],
    ...
    },
    {
        ...
        category: "Camisetas",
        description:
            "Camiseta blanca de algodón orgánico con logo Tesla discreto.",
        sizes: ["S", "M", "L", "XL", "XXL"],
        colors: ["Blanco", "Negro", "Gris"],
    },
    {
        ...
        category: "Sudaderas",
        description:
            "Sudadera negra con capucha y bolsillo frontal tipo canguro.",
        sizes: ["S", "M", "L", "XL", "XXL"],
