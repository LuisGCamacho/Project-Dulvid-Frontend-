...
const stats = [
    {
        ...
        value: "24,567",
        change: "+12.5% respecto al mes anterior",
    ...
    },
    {
        title: "Ingresos",
        value: "$84,230",
        change: "+8.2% respecto al mes anterior",
        changeType: "positive" as const,
        icon: DollarSign,
        color: "bg-green-500",
    },
    {
        title: "Pedidos",
        value: "1,429",
        change: "-2.4% respecto al mes anterior",
    ...
    },
    {
        ...
        value: "3.24%",
        change: "+0.3% respecto al mes anterior",
        changeType: "positive" as const,
        icon: TrendingUp,
        color: "bg-orange-500",
    },
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        {item.views.toLocaleString()} Visitantes
                                    </p>
                                </div>
                                <span
