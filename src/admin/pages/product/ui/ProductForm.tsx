...
export const ProductForm = ({
    ...
    const addSize = (size: Size) => {
        const sizeSet = new Set(getValues("sizes")); // Set que permite valores unicos
        sizeSet.add(size);
        setValue("sizes", Array.from(sizeSet)); // Establecer el arreglo
    };
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        {errors.stock && (
                                            <p className="text-red-500 text-sm">
                                                El inventario debe de ser mayor
                                                a 0
                                            </p>
                                        )}
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        {...register("slug", {
                                            required: true,
                                            validate: (value) =>
                                                !/\s/.test(value) || // Ver si hay espacios en blanco
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="women">Paquete</option>
                                    </select>
                                </div>
